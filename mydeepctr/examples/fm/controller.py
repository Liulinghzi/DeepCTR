...
@LastEditTime: 2020-06-10 13:34:55
...
ModelConfig = model_config_dict['fm']
model_config = ModelConfig(dnn_feature_columns, linear_feature_columns, class_num=2, use_bn=args.use_bn, use_deep=args.use_deep, units=args.units, dropout_rate=args.dropout_rate, activation=args.activation)
