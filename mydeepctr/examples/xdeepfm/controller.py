...
@LastEditTime: 2020-06-09 18:32:39
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: /model-building/recommend/estimator/xdeepfm.py
'''
...
parser.add_argument('--cin_units', type=str, default='10,10')
...
model_config = XDeepFMConfig(dnn_feature_columns, linear_feature_columns, class_num=2, units=[int(unit) for unit in args.units.split(',')], use_bn=args.use_bn, cin_units=[int(u) for u in args.cin_units.strip().split(',')], dropout_rate=args.dropout_rate, activation=args.activation)
