...
@LastEditTime: 2020-06-03 16:48:33
...
import collections
from models.xdeepfm import XDeepFM, XDeepFMConfig
...
def udf_create_model(model_config, features, labels, embedding_initializer=None, mode=tf.estimator.ModeKeys.TRAIN):
    ...
    model = XDeepFM(model_config=model_config, inputs=features, labels=labels, mode=mode)
