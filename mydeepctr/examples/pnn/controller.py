...
@LastEditTime: 2020-06-09 18:57:45
...
parser.add_argument('--method', type=str, default='inner')
...
from models.pnn import PNNConfig
...
model_config = PNNConfig(dnn_feature_columns, linear_feature_columns, class_num=2, method=args.method, use_bn=args.use_bn, units=args.units, activation=args.activation, dropout_rate=args.dropout_rate)
