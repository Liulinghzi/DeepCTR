...
@LastEditTime: 2020-06-04 14:22:49
...
import collections
from models.mlr import MLR, MLRConfig
...
def udf_create_model(model_config, features, labels, embedding_initializer=None, mode=tf.estimator.ModeKeys.TRAIN):
    ...
    model = MLR(model_config=model_config, inputs=features, labels=labels, mode=mode)
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            output_spec = tf.estimator.EstimatorSpec(
                ...
                loss=total_loss,
                train_op=train_op,
                training_hooks=[summary_hook, logging_hook],
