...
@LastEditTime: 2020-06-09 18:32:56
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: /model-building/recommend/estimator/wdl.py
'''
...
from models.wdl import WDLConfig
...
model_config = WDLConfig(dnn_feature_columns, linear_feature_columns, class_num=2, use_bn=args.use_bn, units=args.units, dropout_rate=args.dropout_rate, activation=args.activation)
