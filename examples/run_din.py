...
@LastEditTime: 2020-05-08 14:43:58
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: /code learn/DeepCTR/examples/run_din.py
'''
import numpy as np
...
def get_xy_fd():
    ...
    feature_columns += [VarLenSparseFeat(SparseFeat('hist_item', vocabulary_size=3+1, embedding_dim=8,embedding_name='item'), maxlen=4,),
                        VarLenSparseFeat(SparseFeat('hist_item_gender',vocabulary_size=3+1,embedding_dim=4, embedding_name='item_gender'), maxlen=4)]
